    ...
    <div className="min-h-screen pt-36 pb-16 px-4">
      <div className="max-w-3xl mx-auto">
                ...
                {iller
                  ...
                  .map((il) => (
                    ...
                    >
                      ...
                      <span className={`text-xs font-bold shrink-0 ${pshRenk(pshData[il])}`}>
                        {pshData[il]}h
                      </span>
                    </Link>
                  ))}
        ...
        <motion.div
          ...
          className="mt-6 flex items-center gap-4 text-xs text-slate-500 bg-slate-800/40 border border-slate-700/40 rounded-xl px-4 py-3"
        >
